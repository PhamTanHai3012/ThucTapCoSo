...
namespace TreeVisualizer
{
    public class DrawBox : PictureBox
    {
        ...
        public void Print0<TTree>(ITree tree) where TTree : ITree
        {
        ...
        public void Print1<TTree, TValue>(AVLTree<int> tree, int Value) where TTree : ITree
        {
            _treeNodes = tree.SearchOut(Value);
            _configuration = tree.GetConfiguration();
